      ...
      return (
        <div className="min-h-screen bg-slate-950 flex font-sans text-slate-200">
             ...
             <div className="flex-1 flex flex-col h-screen overflow-y-auto relative">
                <header className="lg:hidden bg-slate-900 border-b border-slate-800 p-4 flex justify-between items-center z-40">
                   <span className="font-bold text-white text-lg">Einstellungen</span>
